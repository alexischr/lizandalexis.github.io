$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Liz and Alexis' Wedding (Boston, MA)",

            // Event start date
            start: new Date('May 24, 2026 16:00'),
            ...
            end: new Date('May 25, 2026 00:00'),
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $.post('https://script.google.com/macros/s/AKfycbzrlt5FPC-K2kEdDU-gOkpUJuffkbwOqZR42VorNhwKsY9evR7in_s-7-vJuLERJAr6/exec', data)
            .done(function (data) {
                console.log(data);
